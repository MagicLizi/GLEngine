...
void engineTestRender(GLManager *glManager)
{
    ...
    GLObject *obj1 = new GLObject(vertices1, sizeof(vertices1), indexVec1, 36, "light1", {});
    obj1->isIndex = false;
    obj1->rotate = glm::vec3(15, -50, 0);
    obj1->scale = glm::vec3(0.5, 0.5, 0.5);
    obj1->color = glm::vec3(1.0f, 0.5f, 0.31);

    // GLObject *obj2 = new GLObject(vertices, sizeof(vertices), indexVec, sizeof(indexVec), "light1", {});
    // obj2->pos = glm::vec3(0, 1, 0);
    // obj2->rotate = glm::vec3(0, 50, 0);
